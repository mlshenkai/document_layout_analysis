...
def main(args):
    ...
    register_coco_instances(
        "publaynet_train",
        {},
        "/code-online/code/structure_cls/PaddleDetection/dataset/dc_structure_dataset/train.json",
        "/code-online/code/structure_cls/PaddleDetection/dataset/dc_structure_dataset/train"
    )
